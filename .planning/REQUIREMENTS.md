...
- [ ] **UPDT-03**: A `scripts/update.sh` script is provided that safely updates crawl4ai (uv/pip upgrade), re-runs playwright install if needed, and confirms the server still starts correctly
